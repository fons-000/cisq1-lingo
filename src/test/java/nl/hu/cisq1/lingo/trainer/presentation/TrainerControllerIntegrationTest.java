...
class TrainerControllerIntegrationTest {
    ...
    void guess4() throws Exception {
        ...
        mockMvc.perform(request)
                ...
                .andExpect(jsonPath("$.roundsDTOS[0].roundOfGame", is(1)))
                .andExpect(jsonPath("$.roundsDTOS[0].firstHint.value", is("N")))
                .andExpect(jsonPath("$.roundsDTOS[0].firstHint.length", is(1)))
                .andExpect(jsonPath("$.roundsDTOS[0].turnDTOS", hasSize(1)))
                .andExpect(jsonPath("$.roundsDTOS[0].turnDTOS[0].feedback.feedbackItems[0]", is("INVALID")))
                .andExpect(jsonPath("$.roundsDTOS[0].turnDTOS[0].feedback.feedbackItems[1]", is("INVALID")))
                .andExpect(jsonPath("$.roundsDTOS[0].turnDTOS[0].feedback.feedbackItems[2]", is("INVALID")))
                .andExpect(jsonPath("$.roundsDTOS[0].turnDTOS[0].feedback.feedbackItems[3]", is("INVALID")))
                .andExpect(jsonPath("$.roundsDTOS[0].turnDTOS[0].hint.value", is("N")))
                .andExpect(jsonPath("$.roundsDTOS[0].turnDTOS[0].hint.length", is(1)))
                .andExpect(jsonPath("$.roundsDTOS[0].turnDTOS[0].guess.value", is("YOLO")))
                .andExpect(jsonPath("$.roundsDTOS[0].turnDTOS[0].guess.length", is(4)))
                .andExpect(jsonPath("$.person.id", is(1)))
                .andExpect(jsonPath("$.person.name", is("Fons Thijssen")))
                .andExpect(jsonPath("$.person.account.id", is(1)))
                .andExpect(jsonPath("$.person.account.password", is("1234")))
